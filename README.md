...
20.8% of appointments are missed. Appointments booked more than 30 days ahead are missed at 33.4%, against 4.8% for same-day bookings, which means roughly 16,800 clinic slots are wasted every month (based on May 2016 volumes).
...
- Row count: 83,930 appointments (April–May 2016 in this cut; June added via the refresh test in section 8)
...
- A reconciliation check that compares the raw row count/total against the summary layer and flags a mismatch.
...
1. **Overall no-show rate is 20.8%** across 83,930 appointments (April–May 2016), and it's stable month over month (19.6% in April, 20.8% in May).
2. **Lead time is the strongest single driver of no-shows.** The rate rises from 4.8% for same-day bookings to 33.4% for bookings made more than 30 days out — roughly a 7x increase.
...
- Two months of appointment data, one city.
